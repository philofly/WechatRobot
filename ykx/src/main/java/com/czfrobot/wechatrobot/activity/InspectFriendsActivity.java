...
public class InspectFriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inspectfriends);


        Log.d("InspectFriendsActivity", Utils.getWechatVersion(this));
                    ...
                    public void onAccessibilityStateChanged(boolean b) {
                        if(b){
                            ...
                            try {
                                ...
                                startActivity(intent);
                                Toast.makeText(InspectFriendsActivity.this, "找到检测被删好友辅助，然后开启服务即可", Toast.LENGTH_LONG).show();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(InspectFriendsActivity.this, DeleteFriendListActivity.class));
            }
        });
    }
}
